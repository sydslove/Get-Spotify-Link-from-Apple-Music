...
OBS: This shortcut relies on the Odesli API. I doubt that its gonna shut down in the near future because it's stable and used widely but if it does then the Shortcut will cease go work. If thats the case, i might update it and fix it in the future.

Oh, and this is my first repo/upload to GitHub so i'm new to this. forgive me for being a noob.
